...
public final class AnatomicaConfig {
    ...
    public static final FloatConfigKey PETITE = new FloatConfigKey("petite", 0.75f, 0.0f, 10.0f);
    ...
    public static final IdentifierConfigKey CLOTH_MODEL_ID = new IdentifierConfigKey("cloth_model",
            Anatomica.id("cloth_basic"),
    ...
    public static final List<RegisteredKey<?>> ENTRIES = List.of(
            ...
            entry(PETITE, BodyConfig::petite, BodyConfig::setPetite),
