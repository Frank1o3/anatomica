...
import com.frank1o3.anatomica.client.physics.AdvancedSoftbodyPhysicsEngine;
 ...
 * both physics simulation and mesh rendering are client-only concerns — this
 * class
...
public final class AnatomicaRegistries {
    ...
    public static void registerClient() {
        ...
        Registry.register(AnatomicaRegistries.CLOTH_MODELS, Anatomica.id("cloth_basic"),
                ClothDeformableModel::new);
    }
}
